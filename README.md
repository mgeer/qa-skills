...
| [qa-gen](qa-gen/skill.md) | Generate missing test code to fill coverage gaps |
...
```
qa-analyze ──▶ qa-gen ──▶ qa-review ──▶ qa-mutate
...
```bash
cp -r qa-analyze qa-gen qa-review qa-mutate ~/.claude/skills/
```
...
/qa-gen P0               # generate tests for critical gaps only
